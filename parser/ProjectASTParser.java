...
public class ProjectASTParser {
	...
	private static class SignatureExtractor extends TreeScanner<Boolean, Void> {
		...
		public Boolean visitClass(ClassTree node, Void p) {
			...
			String f = new File(filename).getName().split("\\.")[0];
	...
	public static void print_uses(ClassObject c){
		...
		for (Connection s : c.getConnections(Type.use)){
			...
			System.out.println(c.get_abstraction() + " " +c.getName() +" uses " + c1.get_abstraction() + " " + c1.getName());		
		}		
	}
	...
	public static void print_inherits(ClassObject c){
		...
		for (Connection s : c.getConnections(Type.inh)){
			ClassObject c1 = s.get_To();
			System.out.println(c.get_abstraction() + " " +c.getName() +" inherits " + c1.get_abstraction() + " " + c1.getName());		
		}		
	}	
	...
	public static void print_has(ClassObject c){
		...
		for (Connection s : c.getConnections(Type.has)){
			ClassObject c1 = s.get_To();
			System.out.println(c.get_abstraction() + " " +c.getName() +" has " + c1.get_abstraction() + " " + c1.getName());		
		}		
	}	
	...
	public static void print_references(ClassObject c){
		...
		for (Connection s : c.getConnections(Type.ref)){
			ClassObject c1 = s.get_To();
			System.out.println(c.get_abstraction() + " " +c.getName() +" references " + c1.get_abstraction() + " " + c1.getName());		
		}		
	}
	...
	public static void print_calls(ClassObject c){
		...
		for (Connection s : c.getConnections(Type.call)){
			ClassObject c1 = s.get_To();
			System.out.println(c.get_abstraction() + " " +c.getName() +" calls " + c1.get_abstraction() + " " + c1.getName());		
		}		
	}	
	...
	public static void print_creates(ClassObject c){
		...
		for (Connection s : c.getConnections(Type.create)){
			ClassObject c1 = s.get_To();
			System.out.println(c.get_abstraction() + " " +c.getName() +" creates " + c1.get_abstraction() + " " + c1.getName());		
		}		
	}
