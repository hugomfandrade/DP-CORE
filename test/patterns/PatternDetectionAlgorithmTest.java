...
public class PatternDetectionAlgorithmTest {
    ...
    public void observerDetection_observerProject() {
        ...
        List<PatternCandidate> patternCandidates = detect(pattern, project);
    ...
    public void allPatterns_combinedProject() {
        ...
        assertEquals(detect(abstractFactoryPattern, project), "MammalFactory", "MammalFactory", "ReptileFactory", "ReptileFactory");
        assertEquals(detect(abstractFactoryV2Pattern, project));
        assertEquals(detect(bridgePattern, project), "Pentagon", "Pentagon", "Triangle", "Triangle");
        assertEquals(detect(bridgeV2Pattern, project));
        assertEquals(detect(builderPattern, project), "MealDirector", "MealDirector");
        assertEquals(detect(commandPattern, project), "ItalianMealBuilder", "JapaneseMealBuilder", "LightOffCommand", "LightOnCommand");
        assertEquals(detect(observerPattern, project), "MyTopic", "MyTopicSubscriber", "ShoppingCartVisitorImpl", "ShoppingCartVisitorImpl");
        assertEquals(detect(visitorPattern, project), "Book", "Fruit");

    }

    @Test
    public void allPatterns_combinedProject_withGrouping() {
    ...
    private static void assertEquals(List<PatternCandidate> patternCandidates, String... expectedMemberConcreteNames) {
