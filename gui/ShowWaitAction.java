...
class ShowWaitAction extends AbstractAction {
   ...
   public void actionPerformed(ActionEvent evt) {
	  ...
	  if (mainWindow.projectfolder==null){
		...
		JOptionPane.showMessageDialog(frame, "Project Folder Location Undefined!", "ERROR", JOptionPane.ERROR_MESSAGE);
	  }
	  else{	
		  ...
		  JOptionPane.showMessageDialog(new JFrame(), "Connections Detected", "JOB'S DONE!", JOptionPane.INFORMATION_MESSAGE);
	  }
   }
}